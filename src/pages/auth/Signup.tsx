      ...
      <Card className="w-full max-w-md bg-background border-border-light shadow-md">
        <CardContent className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-text-secondary">Start creating amazing videos with AI</p>
          </div>
          ...
          <div className="mt-6">
            ...
            <Button variant="ghost" className="w-full mt-4 bg-white text-text-primary border-border" size="lg">
